...
Gname = 'ReactomeFI_2020_remove_UBC_signed_exclude_transcriptional_edges_directed_graph'
...
phos_sites = [x.strip() for x in open('data_files/CCLE_RPPA_phosphosites.txt')]
...
print('Total directed edges: %d' % (len(Gin.edges)))
